...
class NursingNoteController(BaseAPIController):

    def doc_register_nursing_note(self):
        """
        Documentación Swagger para el método register_nursing_note
        
        Returns:
            dict: Documentación Swagger para el endpoint de registrar nota de enfermería
        """
        return {
            "tags": ["Notas de Enfermería"],
            "summary": "Registrar nota de enfemería a un residente",
            "description": """
            Endpoint para registrar una nota de enfemería a un residente específico. 
    ...
    def doc_list_nursing_note_this_resident_range(self):
        """
        Documentación Swagger para el método list_nursing_note_this_resident_range
        
        Returns:
            dict: Documentación Swagger para el endpoint de listar notas de enfemeria de un residente por rango de fechas
        """
        return {
            "tags": ["Notas de Enfermería"],
            "summary": "Listar notas de enfermería de un residente en un rango de fechas",
            "description": """
            ...
            **Cabeceras requeridas:**
            ...
            "responses": {
                "200": {
                    "description": "Lista de notas de enfermería obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                            "description": "Tipo de contenido de la respuesta"
                                    ...
                                    "data": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                "id": {
                                                    "type": "integer",
                                                    "description": "Identificador del registro de  nota de enfermería",
                                                    "example": 15
                                                },
                                                "date": {
                                                    "type": "string",
    ...
    def doc_list_nursing_note_this_resident_all(self):
        """
        Documentación Swagger para el método list_nursing_note_this_resident_all
        ...
        return {
            ...
            "description": """
            Endpoint para obtener todos los registros de notas de enfermería de un residente específico.
            Requiere autenticación JWT válida.
    ...
    def register_nursing_note(self, **post):
        try:
            parameters = [
                'resident_id',
                'date',
            ...
            with registry.cursor() as cr:
                ...
                NursingNote = env['nursing.note'].sudo()
                ...
                if not self._check_user_permissions(user, 'nursing.note', self.CAN_CREATE, env):
 ...
 usuario se autentico") 
                ...
                if record_nn:
                    answer = {
                                "id": record_nn.id,
                                "date": self._convert_to_iso(record_nn.date),
                                "user_id": record_nn.user_id.id,
                                "user_name": record_nn.user_id.name,
                                "resident_id": record_nn.resident_id.id,
                                "resident_name": record_nn.resident_id.name,
                            }     
    ...
    def list_nursing_note_this_resident_range(self, **post):
        try:
            parameters = [
                "resident_id",
            ...
            with registry.cursor() as cr:
                ...
                # - Chequar que el usuario tenga los permisos para hacer
                if not self._check_user_permissions(user, 'nursing.note', self.CAN_READ, env):
                    raise AccessDenied("El usuario no tiene los permisos para esta operación")
...
que usuario se autentico"
                ...
                answer = []
                records_wb = NursingNote.search_read(
                    domain=[
    ...
    def list_nursing_note_this_resident_all(self, **post):
        try:
            parameters = [
                "resident_id",
            ]
