...
class NutritionController(BaseAPIController):

    def doc_register_nutrition(self):
        """
        Documentación Swagger para el método register_nutrition
        ...
        return {
            "tags": ["Alimentos"],
            "summary": "Registrar alimentación a un residente",
            "description": """
            Endpoint para registrar una alimentación a un residente específico. 
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente al cual se le va asignar la  alimentación",
                                "example": 6
                            },
                            "level_nutrition": {
                                "type": "integer",
                                "description": "Identificador del nivel de la alimentación",
                                "example": 8
                            },
                            "date": {
                                "type": "string",
                            ...
                            "description": {
                                "type": "string",
                                "description": "Descripción detallada de la alimentación",
    ...
    def doc_list_nutrition_this_resident_range(self):
        """
        Documentación Swagger para el método list_nutrition_this_resident_range
        
        Returns:
            dict: Documentación Swagger para el endpoint de listar la laimentación de un residente por rango de fechas
        """
        return {
            "tags": ["Alimentos"],
            "summary": "Listar alimentación de un residente en un rango de fechas",
            "description": """
            Endpoint para obtener toda la alimentación de un residente específico
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán la alimentación",
                                "example": 6
                            },
                            "date_start": {
                                "type": "string",
            ...
            "responses": {
                "200": {
                    "description": "Lista de la alimentación obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                            "description": "Tipo de contenido de la respuesta"
                                    ...
                                    "data": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                "id": {
                                                    "type": "integer",
                                                    "description": "Identificador del registro de la alimenatación",
                                                    "example": 15
                                                },
                                                "date": {
                                                    "type": "string",
                                                ...
                                                "level": {
                                                    "type": "object",
                                                    "description": "Objeto con la información del nivel de alimentación",
                                                    "properties": {
                                                        "id": {
                                                            "type": "integer",
                                                        ...
                                                        "percent": {
                                                            "type": "double",
                                                            "description": "Valor que representa el porcentaje de alimentos injeridos por el residente de la ración",
                                                            "example": 50
                                                        }
    ...
    def doc_list_nutrition_this_resident_all(self):
        """
        Documentación Swagger para el método list_nutrition_this_resident_all
        
        Returns:
            dict: Documentación Swagger para el endpoint de listar todas la alimentación de un residente
        """
        return {
            "tags": ["Alimentos"],
            "summary": "Listar todas las anomalías de un residente",
            "description": """
            Endpoint para obtener todos los registros de la alimentación de un residente específico.
            Requiere autenticación JWT válida.
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán todas la alimentación",
                                "example": 6
                            }
                        },
                        "required": [
                                    ...
                                    "data": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                "id": {
                                                    "type": "integer",
                                                    "description": "Identificador del registro de la alimentación",
                                                    "example": 15
                                                },
                                                "date": {
                                                    "type": "string",
    ...
    def register_nutrition(self, **post):
        try:
            parameters = [
                'resident_id',
                'level_nutrition',
            ...
            level_nutrition_id = data['level_nutrition']
            ...
            with registry.cursor() as cr:
                ...
                Nutrition = env['nutrition'].sudo()
                NutritionLevel = env['nutrition.level'].sudo()
                ...
                if not self._check_user_permissions(user, 'nutrition', self.CAN_CREATE, env):
 ...
 usuario se autentico") 
                ...
                # - Chequear que exista el nivel de alimentación 
                nutrition_level = NutritionLevel.browse(level_nutrition_id)

                if not nutrition_level:
                   raise Exception("No existe nivel de alimentación registrado en el sistema con ese identificador")

                if not nutrition_level.active:
                ...
                record_a = Nutrition.create({
                                'resident_id': resident.id,
                                'user_id':user.id,
                                'description': data['description'],
                                'date': date_adjust, 
                                'nutrition_level_id': data['level_nutrition']
                            })
                if record_a:
                    answer = {
                                "id": record_a.id,
    ...
    def list_nutrition_this_resident_range(self, **post):
        try:
            parameters = [
                "resident_id",
            ...
            with registry.cursor() as cr:
                ...
                # - Chequar que el usuario tenga los permisos para hacer
                if not self._check_user_permissions(user, 'nutrition', self.CAN_READ, env):
                    raise AccessDenied("El usuario no tiene los permisos para esta operación")
...
que usuario se autentico"
    ...
    def list_nutrition_this_resident_all(self, **post):
        try:
            parameters = [
                "resident_id",
            ]
...
que usuario se autentico"
                ...
                # Listar todas la notas de Enfermería del residente
                answer = []
                records_wb = Nutrition.search_read(
                    domain=[
                        ("resident_id", "=", resident_id),
                    ],
                    fields=[
