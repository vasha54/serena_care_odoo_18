...
class HygieneTypeAPIController(BaseAPIController):
    
    def doc_get_list_hygiene_type(self):
        """
        Documentación Swagger para el método get_list_hygiene_type
        ...
        return {
            "tags": ["Higiene"],
            "summary": "Lista los tipos de higiene",
            "description": (
                "Retorna un listado de todos  tipos de higienes disponibles en el sistema "
                "con su ID y nombre. Usado en el proceso de registrar un chequeo de higiene de un residente."
            ),
            "responses": {
                "200": {
                    "description": "Listado de los tipos de higiene obtenido exitosamente",
                    "content": {
                        "application/json": {
                            "schema": {
                                "type": "object",
                                "properties": {
                                    ...
                                    "data": {
                                        "type": "array",
                                        "description": "Arreglo de objetos con información de los tipos de higiene",
                                        "items": {
                                            "type": "object",
                                            "properties": {
                                                "id": {
                                                    "type": "integer",
                                                    "description": "ID único del tipo de higiene",
                                                    "example": 1
                                                },
                                                "name": {
                                                    "type": "string",
    ...
    def get_list_hygiene_type(self, **kwargs):
        try:
            data = (
                request.env["hygiene.type"]
                .sudo()
                .search_read(
                    domain = [("active","=",True)],
                    fields = ["id", "name"],
