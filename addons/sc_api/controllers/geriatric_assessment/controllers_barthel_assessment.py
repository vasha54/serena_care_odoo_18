...
class BarthelAssessmentAPIController(BaseAPIController):
    def doc_list_barthel_assessment_this_resident_range(self):
        """
        Documentación Swagger para el método list_barthel_assessment_this_resident_range

        Returns:
            dict: Documentación Swagger para el endpoint de listar evaluaciones de Barthel por rango de fechas
        """
        return {
            "tags": ["Evaluación Geriatrica - Barthel"],
            "summary": "Listar evaluaciones de Barthel de un residente en un rango de fechas",
            "description": """
            Endpoint para obtener las evaluaciones de Barthel de un residente específico
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán las evaluaciones de Barthel",
                                "example": 4,
                            },
                            "date_start": {
                                "type": "string",
            ...
            "responses": {
                "200": {
                    "description": "Lista de evaluaciones de Barthel obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                                    ...
                                    "data": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                "id": {
                                                    "type": "integer",
                                                    "description": "Identificador del registro de evaluación de Barthel",
                                                    "example": 9,
                                                },
                                                "date": {
                                                    "type": "string",
                                                ...
                                                "barthel_state_display": {
                                                    "type": "string",
                                                    "description": "Estado de Barthel interpretado basado en el puntaje",
                                                    "example": "Dependencia severa",
                                                },
                                                "observations": {
                                                    "type": "string",
                                                    "description": "Nota de observación sobre la ejecución de la evaluación",
    ...
    def doc_list_barthel_assessment_this_resident_all(self):
        """
        Documentación Swagger para el método list_barthel_assessment_this_resident_all

        Returns:
            dict: Documentación Swagger para el endpoint de listar todas las evaluaciones de Barthel de un residente
        """
        return {
            "tags": ["Evaluación Geriatrica - Barthel"],
            "summary": "Listar todas las evaluaciones de Barthel de un residente",
            "description": """
            Endpoint para obtener todos los registros de evaluaciones de Barthel de un residente específico.
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán todas las evaluaciones de Barthel",
                                "example": 4,
                            }
                        },
            ...
            "responses": {
                "200": {
                    "description": "Lista completa de evaluaciones de Barthel obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                            "description": "Tipo de contenido de la respuesta",
    ...
    def list_barthel_assessment_this_resident_range(self, **post):
        try:
            parameters = [
                "resident_id",
            ...
            with registry.cursor() as cr:
                ...
                if not self._check_user_permissions(user, 'barthel.assessment', self.CAN_READ, env):
...
que usuario se autentico"
                ...
                answer = []
                records = BarthelAssessment.search_read(
                    domain=[
                        ...
                        answer.append(
                            {
                                ...
                                "barthel_state_display": wb["barthel_state_display"],
    ...
    def list_barthel_assessment_this_resident_all(self, **post):
        try:
            parameters = [
                "resident_id",
            ]
