...
class ScaleFRAILAssessmentAPIController(BaseAPIController):
    def doc_list_frail_assessment_this_resident_range(self):
        """
        Documentación Swagger para el método list_frail_assessment_this_resident_range

        Returns:
            dict: Documentación Swagger para el endpoint de listar evaluaciones de FRAIL por rango de fechas
        """
        return {
            "tags": ["Evaluación Geriatrica - FRAIL"],
            "summary": "Listar evaluaciones de FRAIL de un residente en un rango de fechas",
            "description": """
            Endpoint para obtener las evaluaciones de FRAIL de un residente específico
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán las evaluaciones de FRAIL",
                                "example": 4,
                            },
                            "date_start": {
                                "type": "string",
            ...
            "responses": {
                "200": {
                    "description": "Lista de evaluaciones de FRAIL obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                                    ...
                                    "data": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                "id": {
                                                    "type": "integer",
                                                    "description": "Identificador del registro de evaluación de FRAIL",
                                                    "example": 5,
                                                },
                                                "date": {
                                                    "type": "string",
                                                ...
                                                "scalefrail_state_display": {
                                                    "type": "string",
                                                    "description": "Estado de FRAIL interpretado basado en el puntaje",
    ...
    def doc_list_frail_assessment_this_resident_all(self):
        """
        Documentación Swagger para el método list_frail_assessment_this_resident_all

        Returns:
            dict: Documentación Swagger para el endpoint de listar todas las evaluaciones de FRAIL de un residente
        """
        return {
            "tags": ["Evaluación Geriatrica - FRAIL"],
            "summary": "Listar todas las evaluaciones de FRAIL de un residente",
            "description": """
            Endpoint para obtener todos los registros de evaluaciones de FRAIL de un residente específico.
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán todas las evaluaciones de FRAIL",
                                "example": 4,
                            }
                        },
            ...
            "responses": {
                "200": {
                    "description": "Lista completa de evaluaciones de FRAIL obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                            "description": "Tipo de contenido de la respuesta",
    ...
    def list_frail_assessment_this_resident_range(self, **post):
        try:
            parameters = [
                "resident_id",
            ...
            with registry.cursor() as cr:
                ...
                FRAILAssessment = env["scalefrail.assessment"].sudo()
                ...
                if not self._check_user_permissions(user, 'scalefrail.assessment', self.CAN_READ, env):
...
que usuario se autentico"
                ...
                answer = []
                records = FRAILAssessment.search_read(
                    domain=[
    ...
    def list_frail_assessment_this_resident_all(self, **post):
        try:
            parameters = [
                "resident_id",
            ]
