...
class ScaleSARCFAssessmentAPIController(BaseAPIController):
    def doc_list_sarcf_assessment_this_resident_range(self):
        """
        Documentación Swagger para el método list_sarcf_assessment_this_resident_range

        Returns:
            dict: Documentación Swagger para el endpoint de listar evaluaciones de SARC-F por rango de fechas
        """
        return {
            "tags": ["Evaluación Geriatrica - SARC-F"],
            "summary": "Listar evaluaciones de SARC-F de un residente en un rango de fechas",
            "description": """
            Endpoint para obtener las evaluaciones de SARC-F de un residente específico
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán las evaluaciones de SARC-F",
                                "example": 4,
                            },
                            "date_start": {
                                "type": "string",
            ...
            "responses": {
                "200": {
                    "description": "Lista de evaluaciones de SARC-F obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                                    ...
                                    "data": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                "id": {
                                                    "type": "integer",
                                                    "description": "Identificador del registro de evaluación de SARC-F",
                                                    "example": 5,
                                                },
                                                "date": {
                                                    "type": "string",
                                                ...
                                                "scalesarcf_state_display": {
                                                    "type": "string",
                                                    "description": "Estado de SARC-F interpretado basado en el puntaje",
    ...
    def doc_list_sarcf_assessment_this_resident_all(self):
        """
        Documentación Swagger para el método list_sarcf_assessment_this_resident_all

        Returns:
            dict: Documentación Swagger para el endpoint de listar todas las evaluaciones de SARC-F de un residente
        """
        return {
            "tags": ["Evaluación Geriatrica - SARC-F"],
            "summary": "Listar todas las evaluaciones de SARC-F de un residente",
            "description": """
            Endpoint para obtener todos los registros de evaluaciones de SARC-F de un residente específico.
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán todas las evaluaciones de SARC-F",
                                "example": 4,
                            }
                        },
            ...
            "responses": {
                "200": {
                    "description": "Lista completa de evaluaciones de SARC-F obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                            "description": "Tipo de contenido de la respuesta",
    ...
    def list_sarcf_assessment_this_resident_range(self, **post):
        try:
            parameters = [
                "resident_id",
            ...
            with registry.cursor() as cr:
                ...
                SARCFAssessment = env["scalesarcf.assessment"].sudo()
                ...
                if not self._check_user_permissions(user, 'scalesarcf.assessment', self.CAN_READ, env):
...
que usuario se autentico"
                ...
                answer = []
                records = SARCFAssessment.search_read(
                    domain=[
    ...
    def list_sarcf_assessment_this_resident_all(self, **post):
        try:
            parameters = [
                "resident_id",
            ]
