...
class ScaleGDS5AssessmentAPIController(BaseAPIController):
    def doc_list_gds5_assessment_this_resident_range(self):
        """
        Documentación Swagger para el método list_gds5_assessment_this_resident_range

        Returns:
            dict: Documentación Swagger para el endpoint de listar evaluaciones de GDS-5 por rango de fechas
        """
        return {
            "tags": ["Evaluación Geriatrica - GDS-5"],
            "summary": "Listar evaluaciones de GDS-5 de un residente en un rango de fechas",
            "description": """
            Endpoint para obtener las evaluaciones de GDS-5 de un residente específico
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán las evaluaciones de GDS-5",
                                "example": 4,
                            },
                            "date_start": {
                                "type": "string",
            ...
            "responses": {
                "200": {
                    "description": "Lista de evaluaciones de GDS-5 obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                                    ...
                                    "data": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                "id": {
                                                    "type": "integer",
                                                    "description": "Identificador del registro de evaluación de GDS-5",
                                                    "example": 5,
                                                },
                                                "date": {
                                                    "type": "string",
                                                ...
                                                "scalegds5_state_display": {
                                                    "type": "string",
                                                    "description": "Estado de GDS-5 interpretado basado en el puntaje",
                                                    ...
                                                    "items": {
                                                        ...
                                                        "properties": {
                                                            "question_statement": {
                                                                ...
                                                                "example": "¿Está básicamente satisfecho con su vida?",
                                                            },
                                                            "answer_select": {
                                                                "type": "string",
                                                                "description": "Respuesta del residente en formato de texto (Sí/No)",
                                                                "example": "Sí",
                                                            },
                                                        },
                                                    },
    ...
    def doc_list_gds5_assessment_this_resident_all(self):
        """
        Documentación Swagger para el método list_gds5_assessment_this_resident_all

        Returns:
            dict: Documentación Swagger para el endpoint de listar todas las evaluaciones de GDS-5 de un residente
        """
        return {
            "tags": ["Evaluación Geriatrica - GDS-5"],
            "summary": "Listar todas las evaluaciones de GDS-5 de un residente",
            "description": """
            Endpoint para obtener todos los registros de evaluaciones de GDS-5 de un residente específico.
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán todas las evaluaciones de GDS-5",
                                "example": 4,
                            }
                        },
            ...
            "responses": {
                "200": {
                    "description": "Lista completa de evaluaciones de GDS-5 obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                            "description": "Tipo de contenido de la respuesta",
    ...
    def list_gds5_assessment_this_resident_range(self, **post):
        try:
            parameters = [
                "resident_id",
            ...
            with registry.cursor() as cr:
                ...
                GDS5Assessment = env["scalegds5.assessment"].sudo()
                ...
                if not self._check_user_permissions(user, 'scalegds5.assessment', self.CAN_READ, env):
...
que usuario se autentico"
                ...
                answer = []
                records = GDS5Assessment.search_read(
                    domain=[
                        ...
                        answer.append(
                            {
                                ...
                                "scalegds5_state_display": wb[
                                    "scalegds5_state_display"
                                ],
                                "clinic_note": wb["clinic_note"],
    ...
    def list_gds5_assessment_this_resident_all(self, **post):
        try:
            parameters = [
                "resident_id",
            ]
