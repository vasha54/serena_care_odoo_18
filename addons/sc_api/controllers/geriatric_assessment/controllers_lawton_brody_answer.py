...
class LawtonBrodyAnswerAPIController(BaseAPIController):

    def doc_register_lawtonbrody_answers(self):
        """
        Documentación Swagger para el método register_lawtonbrody_answers

        Returns:
            dict: Documentación Swagger para el endpoint de registrar respuestas de evaluación de Lawton-Brody
        """
        return {
            "tags": ["Evaluación Geriatrica - Lawton-Brody"],
            "summary": "Registrar respuestas de evaluación de Lawton-Brody para un residente",
            "description": """
            Endpoint para registrar una evaluación completa de Lawton-Brody de un residente,
            ...
            **Proceso:**
            ...
            4. Crea una evaluación de Lawton-Brody
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente al cual se le aplica la evaluación de Lawton-Brody",
                                "example": 4
                            },
                            "observations": {
                                "type": "string",
                                "description": "Cadena de texto o vacía que contiene alguna observación reerente al residente cuando se le aplica la evaluación de Lawton-Brody",
                            ...
                            "answers": {
                                "type": "array",
                                "description": "Lista de respuestas a las preguntas del cuestionario de Lawton-Brody",
                                "items": {
                                    "type": "object",
                                    "properties": {
                                        "question_id": {
                                            "type": "integer",
                                            "description": "Identificador de la pregunta del cuestionario de Lawton-Brody",
                                            "example": 1
                                        },
                                        "choise_id": {
                                            "type": "integer",
            ...
            "responses": {
                "200": {
                    "description": "Evaluación de Lawton-Brody registrada exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                                ...
                                "properties": {
                                    ...
                                    "data": {
                                        ...
                                        "properties": {
                                            "id": {
                                                "type": "integer",
                                                "description": "Identificador de la evaluación de Lawton-Brody creada",
                                                "example": 6
                                            },
                                            "date": {
                                                "type": "string",
                ...
                "404": {
                    "description": "Residente no encontrado o pregunta de Lawton-Brody no existe",
                    "schema": {
                        "type": "object",
                        "properties": {
                            "status": {
                            ...
                            "message": {
                                "type": "string",
                                "example": "Residente no encontrado o pregunta de Lawton-Brody no existe en el sistema"
                            },
                            "data": {
                                "type": "null",
                                "example": None
    ...
    def register_lawtonbrody_answers(self, **kwargs):
        try:
            parameters = [
                'resident_id',
                'answers',
            ...
            lawtonbrody_answers = data['answers']
            ...
            with registry.cursor() as cr:
                ...
                LawtonBrodyAnswer = env['lawtonbrody.answer'].sudo()
                LawtonBrodyQuestion = env['lawtonbrody.question'].sudo()
                LawtonBrodyChoise = env['lawtonbrody.choise'].sudo()
                ...
                if not self._check_user_permissions(user, 'lawtonbrody.assessment', self.CAN_CREATE, env):
                    raise AccessDenied("El usuario no tiene los permisos para esta operación")
                
                if not self._check_user_permissions(user, 'lawtonbrody.answer', self.CAN_CREATE, env):
                    raise AccessDenied("El usuario no tiene los permisos para esta operación")
 ...
 usuario se autentico")
                ...
                for index, obj in enumerate(lawtonbrody_answers):
                    ...
                    question = LawtonBrodyQuestion.browse(question_id)
                    choise = LawtonBrodyChoise.browse(choise_id)

                    if not question:
                        raise Exception("No existe una pregunta de Lawton-Brody en el sistema con ese identificador")
                    if not question.active:
                        raise Exception("La pregunta de estado de Lawton-Brody no se encuentra activa ")
                    if not choise:
                        raise Exception("No existe una opción selecionada como respuesta de una pregunta Lawton-Brody en el sistema con ese identificador")
                ...
                # - Crear evaluacion
                assessment = LawtonBrodyAssessment.create({
