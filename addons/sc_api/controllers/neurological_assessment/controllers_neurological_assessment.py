...
class NeurologicalAssessmentController(BaseAPIController):

    def doc_register_neurological_assessment(self):
        """
        Documentación Swagger para el método register_neurological_assessment
        ...
        return {
            ...
            "summary": "Registrar evaluación neurológica a un residente",
            "description": """
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente al cual se le va registrar la evaluación neurológica",
                                "example": 6
                            },
                            "state_neurological": {
                                "type": "integer",
                                "description": "Identificador del estado neurológico",
                                "example": 8
                            },
                            "date": {
                                "type": "string",
                                ...
                                "properties": {
                                    ...
                                    "data": {
                                        ...
                                        "properties": {
                                            "id": {
                                                "type": "integer",
                                                "description": "Identificador del registro de la evaluación",
                                                "example": 15
                                            },
                                            "date": {
                                                "type": "string",
    ...
    def doc_list_neurological_assessment_this_resident_range(self):
        """
        Documentación Swagger para el método list_neurological_this_resident_range
        
        Returns:
            dict: Documentación Swagger para el endpoint de listar las evaluaciones neurológicas de un residente por rango de fechas
        """
        return {
            "tags": ["Evaluación Neurológica"],
            "summary": "Listar las evaluaciones neurológicas de un residente en un rango de fechas",
            "description": """
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán las evaluaciones",
                                "example": 6
                            },
                            "date_start": {
                                "type": "string",
            ...
            "responses": {
                "200": {
                    "description": "Lista de las evaluaciones neurológicas obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                            "description": "Tipo de contenido de la respuesta"
                                    ...
                                    "data": {
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                ...
                                                "neurological_state": {
                                                    "type": "object",
                                                    "description": "Objeto con la información del estado neurológico",
                                                    "properties": {
                                                        "id": {
                                                            "type": "integer",
                                                ...
                                                "description": {
                                                    "type": "string",
                                                    "description": "Descripción detallada de la evaaluacion",
                                                    "example": "Revisión general de salud y actualización de medicamentos"
                                                }
                                            }
                                        }
    ...
    def doc_list_neurological_assessment_this_resident_all(self):
        """
        Documentación Swagger para el método list_neurological_this_resident_all
        
        Returns:
            dict: Documentación Swagger para el endpoint de listar todas las evaluaciones neurologícas de un residente
        """
        return {
            "tags": ["Evaluación Neurológica"],
            "summary": "Listar todas las evaluiaciones neurológicas de un residente",
            "description": """
            ...
            **Cabeceras requeridas:**
                ...
                },
                {
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "resident_id": {
                                "type": "integer",
                                "description": "Identificador del residente del cual se consultarán todas las evaluaciones neurologicas",
                                "example": 6
                            }
                        },
                        "required": [
            ...
            "responses": {
                "200": {
                    "description": "Lista completa de las evaluaciones neurológicas obtenida exitosamente",
                    "headers": {
                        "Content-Type": {
                            "type": "string",
                            "description": "Tipo de contenido de la respuesta"
                                        ...
                                        "items": {
                                            ...
                                            "properties": {
                                                ...
                                                "date": {
                                                    "type": "string",
                                                    "format": "date-time",
                                                    "description": "Fecha y hora de registro de la evaluación en formato YYYY-MM-DD HH:MM",
                                                    "example": "2025-08-20 10:00:00"
                                                },
                                                "user": {
                                                    "type": "object",
    ...
    def register_neurological_assessment(self, **post):
        try:
            parameters = [
                'resident_id',
                'state_neurological',
            ...
            state_neurological_id = data['state_neurological']
            ...
            with registry.cursor() as cr:
                ...
                NeurologicalAssessment = env['neurological.assessment'].sudo()
                NeurologicalState = env['neurological.state'].sudo() 
                ...
                if not self._check_user_permissions(user, 'neurological.assessment', self.CAN_CREATE, env):
 ...
 usuario se autentico") 
                ...
                neurological_state = NeurologicalState.browse(state_neurological_id)

                if not neurological_state:
                   raise Exception("No existe estado neurológico registrado en el sistema con ese identificador")

                if not neurological_state.active:
                   raise Exception("El estado neurológico no esta activo")

                date_adjust = self._adjust_timezone(user, data['date'])
                # Registrar la nota de enfermería
                record_a = NeurologicalAssessment.create({
                                'resident_id': resident.id,
                                'user_id':user.id,
                                'description': data['description'],
                                'date': date_adjust, 
                                'neurological_state_id': data['state_neurological']
                            })
                if record_a:
                    answer = {
                                "id": record_a.id,
    ...
    def list_neurological_assessment_this_resident_range(self, **post):
        try:
            parameters = [
                "resident_id",
            ...
            with registry.cursor() as cr:
                ...
                # - Chequar que el usuario tenga los permisos para hacer
                if not self._check_user_permissions(user, 'neurological.assessment', self.CAN_READ, env):
                    raise AccessDenied("El usuario no tiene los permisos para esta operación")
...
que usuario se autentico"
                ...
                answer = []
                records = NeurologicalAssessment.search_read(
                    domain=[
                        ...
                        answer.append(
                            {
                                ...
                                "neurological_state": wb["neurological_state"]
                            }
                        )
    ...
    def list_neurological_assessment_this_resident_all(self, **post):
        try:
            parameters = [
                "resident_id",
            ]
...
que usuario se autentico"
                ...
                answer = []
                records_wb = NeurologicalAssessment.search_read(
                    domain=[
                        ("resident_id", "=", resident_id),
                    ],
                    fields=[
