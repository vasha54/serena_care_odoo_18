...
class ResidenceHouse(models.Model):
    ...
    def write(self, vals):
        ...
        for record in self:
            ...
            self.env['audit.log'].sudo().crud_audit_log(record, 'residence_house', 'write', extra_details=details)
        return result
    ...
    def create(self, vals):
        ...
        for record in records:
            self.env['audit.log'].sudo().crud_audit_log(record, 'residence_house', 'create')
        return records 
